...
class KeywordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create keyword" do
    assert_difference('Keyword.count') do
      post keywords_url, params: { keyword: { user_id: @keyword.user_id, word: @keyword.word } }
    end
  ...
  test "should update keyword" do
    patch keyword_url(@keyword), params: { keyword: { user_id: @keyword.user_id, word: @keyword.word } }
