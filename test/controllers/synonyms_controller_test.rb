...
class SynonymsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create synonym" do
    assert_difference('Synonym.count') do
      post synonyms_url, params: { synonym: { keyword_1_id: @synonym.keyword_1_id, keyword_2_id: @synonym.keyword_2_id, strength: @synonym.strength } }
    end
  ...
  test "should update synonym" do
    patch synonym_url(@synonym), params: { synonym: { keyword_1_id: @synonym.keyword_1_id, keyword_2_id: @synonym.keyword_2_id, strength: @synonym.strength } }
